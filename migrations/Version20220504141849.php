 ...
 */
final class Version20220504141849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE societe (id INT AUTO_INCREMENT NOT NULL, form_juridique_id INT NOT NULL, nom VARCHAR(255) NOT NULL, siren VARCHAR(9) NOT NULL, ville_immatriculation VARCHAR(255) NOT NULL, capital VARCHAR(255) NOT NULL, date_changement_immatriculation DATETIME DEFAULT NULL, date_immatriculation DATE NOT NULL, UNIQUE INDEX UNIQ_19653DBD70C59830 (form_juridique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
